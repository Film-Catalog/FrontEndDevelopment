    ...
    return(
        ...
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center space-x-4">
                <img src={movie} alt="Logo" class="h-16 w-auto"/>
                <span class="text-gray-300 text-lg font-semibold">Your Company</span>
            </div>
            ...
            {/* <!-- WhatsApp --> */}
            <a href="#" class="text-gray-300 hover:text-accent" aria-label="WhatsApp">
            ...
            {/* <!-- Twitter --> */}
            <a href="#" class="text-gray-300 hover:text-accent" aria-label="Twitter">
            ...
            {/* <!-- Instagram --> */}
            <a href="#" class="text-gray-300 hover:text-accent" aria-label="Instagram">
                <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
